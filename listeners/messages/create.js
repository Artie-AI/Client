        ...
        if (message.guild) {
            ...
            if (user_check.banned) {
                if (message.content.startsWith(`<@${message.client.user.id}>`) || message.content.startsWith(`<@!${message.client.user.id}>`)) {
                    return message.author.send({
                        content: 'Hey there, i am ignoring your base messages because you have been banned from using my services. Join here to resolve this: https://discord.gg/RPqGSeAnPf',
                    }).catch(() => {
            ...
            if (user_check && user_check.banned) {
                return message.reply({
                    content: 'Hey there, you have been banned from using my services. Join here to resolve this: https://discord.gg/RPqGSeAnPf',
                })
            }
