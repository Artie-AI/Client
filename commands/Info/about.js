...
module.exports = {
  ...
  run: async (client, interaction) => {
    const row = new client.Artie.MessageActionRow().addComponents(
    ...
    const embed = new client.Artie.MessageEmbed()
      ...
      .setDescription(
        `Unlike other AI Artie is a Deep Machine Learning AI that uses basic human science such as a brain for its responses.`
      )
      .addField(
        "Creator",
        "[Toxic Dev#5936](https://github.com/TheRealToxicDev)",
        true
      )
      .addField(
        "Created",
        `${moment(client.user.createdAt).format("MM/DD/YYYY HH:mm:ss A")}`,
        true
      )
